...
export function V3() {
  return (
    <div style={{ minHeight: "100vh", background: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 24, fontFamily: "sans-serif", direction: "rtl" }}>
      <p style={{ fontSize: 13, color: "#888", marginBottom: 4 }}>خيار ٣ — ذهبي لامع بـ box-shadow (مقترحي)</p>
      <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
        {categories.map((cat, i) => (
          <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8 }}>
            {/* box-shadow ring لامع */}
            <div style={{
              width: 62, height: 62, borderRadius: "50%", overflow: "hidden",
              boxShadow: i === 0
                ? "0 0 0 2px #D4A017, 0 0 12px rgba(212,160,23,0.55)"
                : "0 0 0 1.5px #B8860B",
              background: "#fafaf9",
            }}>
      ...
      <p style={{ fontSize: 11, color: "#aaa", marginTop: 8 }}>box-shadow 1.5px • #B8860B • الصورة تملأ الدائرة كاملاً</p>
    </div>
  );
}
